...
describe('render component <MultilevelFilterComponent />', () => {
  ...
  describe('when receive options prop', () => {
    it(
      'should show list when click on "filtrar" and first level contains ' +
        'class list-level-0',
      () => {
    ...
    it(
      'should show list of child recursive on level option when click on ' +
        '"Filtrar"',
      () => {
        const { container, getByText } = render(
          <MultilevelFilterComponent
    ...
    it(
      'should hide list when press on item label and not have prop ' +
        'notSelectable',
      () => {
        const { container, getByText } = render(
          <MultilevelFilterComponent
    ...
    it('Should add class to itemList in dependence notSelectable prop', () => {
      const { getByText, container } = render(
        <MultilevelFilterComponent
          onChangeValue={mockOnChange}
          options={mockOptions}
  ...
  describe('when receive values prop', () => {
    it(
      'should show instead of placeholder the list of labels of options ' +
        'included on values',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
    ...
    it(
      'should add selected-option class at labels when id included on ' +
        'values and no children or all children is included on values',
      () => {
        const { getByText, container } = render(
          <MultilevelFilterComponent
            placeholder="select items"
        ...
        fireEvent.click(
          getByText(
            'Filter 1 1 1, Filter 1 1 2, Filter 2, Filter 3 1 1, ' +
              'Filter 3 1 2, Filter 3 1 3'
          )
        )
        expect(
          container
  ...
  describe(
    'when receive onChangeValue and valueId props and click on ' + 'item',
    () => {
      it(
        'should call onChangeValue with values + itemId and valueId when ' +
          'dont have children and id dont include in values',
        () => {
          const { getByText } = render(
            <MultilevelFilterComponent
              options={mockOptions}
      ...
      it(
        'should call onChangeValue with values + itemId and valueId when ' +
          'children lenth equal 0 and id dont include in values',
        () => {
          const { getByText } = render(
            <MultilevelFilterComponent
              options={mockOptions}
      ...
      it(
        'should call onChangeValue with values without itemId when dont have ' +
          'children and id include in values',
        () => {
          const { getByText } = render(
            <MultilevelFilterComponent
              options={mockOptions}
      ...
      it(
        'should call onChangeValue with values added all children itemsId ' +
          'when item have children and values not include all children id',
        () => {
          const { getByText } = render(
            <MultilevelFilterComponent
              options={mockOptions}
      ...
      it(
        'should call onChangeValue with the values removing all children ite' +
          'msId when item have children and all children id included on values',
        () => {
          const { getByText } = render(
            <MultilevelFilterComponent
              options={mockOptions}
      ...
      it(
        'should do not call onChangeValue when item have notSelectable ' +
          'prop',
        () => {
  ...
  describe('when receive labelClassName prop', () => {
    it(
      'should replace label class on the component when have labelClassName ' +
        'prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
    ...
    it(
      'should have class label on the component when do not have ' +
        'labelClassName prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
  ...
  describe('when receive selectorClassName prop', () => {
    it(
      'should replace selector class on the component when have ' +
        'selectorClassName prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
    ...
    it(
      'should have class selector on the component when do not have ' +
        'selectorClassName prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
  ...
  describe('when receive optionsClassName prop', () => {
    it(
      'should replace options class on the component when have ' +
        'optionsClassName prop',
      () => {
        const { container, getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
    ...
    it(
      'should add options class selected-option on the component when do not ' +
        'have optionsClassName prop',
      () => {
        const { container, getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive extraLabelClassName prop', () => {
    it(
      'should add to label class the extraLabelClassName when have ' +
        'extraLabelClassName prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive extraOptionsClassName prop', () => {
    it(
      'should add to options class the extraOptionsClassName when have ' +
        'extraOptionsClassName prop',
      () => {
        const { getByText, container } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive extraSelectorClassName prop', () => {
    it(
      'should add to selector class the extraSelectorClassName when have ' +
        'extraSelectorClassName prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive maxSelectorWidth prop', () => {
    it(
      'should add to selector style maxWidth equal to maxSelectorWidth ' +
        'prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
        ...
        ).toEqual('max-width: 300px;')
      }
    )

    it(
      'should do not have maxWidth when do not have maxSelectorWidth ' + 'prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive minSelectorWidth prop', () => {
    it(
      'should add to selector style minWidth equal to minSelectorWidth ' +
        'prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
        ...
        expect(
          getByText('Filtrar').parentElement.getAttribute('style')
        ).toEqual('min-width: 100px;')
      }
    )

    it(
      'should do not have minWidth when do not have minSelectorWidth ' + 'prop',
      () => {
        const { getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive minOptionsWidth prop', () => {
    it(
      'should add to options style minWidth equal to minOptionsWidth ' + 'prop',
      () => {
        const { getByText, container } = render(
          <MultilevelFilterComponent
            options={mockOptions}
    ...
    it(
      'should do not have options style minWidth when do not have ' +
        'minOptionsWidth prop',
      () => {
        const { container, getByText } = render(
          <MultilevelFilterComponent
            options={mockOptions}
  ...
  describe('when receive customIcon prop', () => {
    it(
      'should replace arrow by customIcon prop content when have ' +
        'customIcon',
      () => {
    ...
    it(
      'should do not replace arrow by customIcon when do not have ' +
        'customIcon',
      () => {
        const { container } = render(
          <MultilevelFilterComponent
